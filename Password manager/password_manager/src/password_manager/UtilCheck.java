...
public class UtilCheck {
	...
	public static boolean is_email_valid(String email) {
		 ...
		 * 
		 * A-Z match all from A-Z 
		 *  0-9 matches a number between 0-9 (all possible number)
		 *  ._%+- matches a single character
		 * in the list ._%+- (case sensitive) for email this is allowed
		 * 
		 * @ matches the character @ 
		 * the second bracket is the same as the prev bracket 
		 ...
		 * 
		 * [A-Z] {2,6} matches the previous
		 * take  between 2 - 6 chars  can be like com, id, org or etc
		 * 
		 */
